...
class PhotozRandomForest:
    ...
    def save_results(self):
        ...
        # Save prediction-only files (z, z_pred, z_err)
    ...
    def _save_predictions(self):
        """Save prediction results (z, z_pred, z_err) to separate files."""
        save_dir = self.config.get_save_dir()

        # Compute uncertainties for all sets
        X_train = self._get_features(self.train_df)
    ...
    def predict(self, data_source, return_uncertainty=True):
        ...
        Args:
            ...
            return_uncertainty: Whether to compute uncertainty from tree variance
        ...
        if return_uncertainty:
            # Use all trees to predict to estimate uncertainty
...
class PhotozRFInference:
    ...
    def __init__(self, model_dir: str):
        ...
        Args:
            model_dir: Path to the model directory containing config.yaml and rf_model.joblib
        """
